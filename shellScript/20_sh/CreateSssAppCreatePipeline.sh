...
echo "Create SSS APP CreatePipeline..."

aws cloudformation create-stack \
--stack-name gtc-sss-app-s3-pipeline-create-deploy-$ENVIRONMENT-$AREA \
--template-url https://s3.amazonaws.com/gtc-$ENVIRONMENT-$AREA-s3-cfn-cicd-infra/sss-app-s3-pipeline-create-stack.yml \
--parameters \
