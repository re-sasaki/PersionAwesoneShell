...
echo "Create PielineCreatePipeline..."

aws cloudformation create-stack \
--stack-name gtc-infra-s3-pipeline-create-deploy-$ENVIRONMENT-$AREA \
--template-url https://s3.amazonaws.com/gtc-$ENVIRONMENT-$AREA-s3-cfn-cicd-infra/infra-s3-pipeline-create-stack.yml \
--parameters \
