...
echo "Create EcrPipeline..."
aws cloudformation create-stack \
--stack-name gtc-ecr-deploy-$ENVIRONMENT-$AREA-cfn-cicd \
--template-url https://s3.amazonaws.com/gtc-$ENVIRONMENT-$AREA-s3-cfn-cicd-infra/ecr-system-deploy-stack.yml \
--parameters \
...
ParameterKey=SettingBucketName,ParameterValue=gtc-infra-pipeline-create-$ENVIRONMENT-$AREA-s3-deploy-settings \
