...
echo "Create Redmine Base..."

aws cloudformation create-stack \
--template-url https://s3-ap-northeast-1.amazonaws.com/gtc-redmine-$ENVIRONMENT-$AREA-s3-cfn-cicd/gtc-redmine-base-stack.yml \
--stack-name gtc-redmine-$ENVIRONMENT-$AREA-base-stack \
