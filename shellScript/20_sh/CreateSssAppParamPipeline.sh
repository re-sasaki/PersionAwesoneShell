...
echo "Create SssAppParamPipeline..."

aws cloudformation create-stack \
--stack-name gtc-sss-app-parameterstore-deploy-$ENVIRONMENT-$AREA \
--template-url https://s3.amazonaws.com/gtc-$ENVIRONMENT-$AREA-s3-cfn-cicd-infra/sss-app-deploy-stack.yml \
--parameters \
